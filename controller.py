import datetime
from application.app.twitter.store_data import StoreData
...
class Controller():
    ...
    def twitter_crawler(self):
        ...
        insert_ids =[mongo_obj.insert_data({"key_phrase":key_phrase,"start_date":today_date,"method":self.method,"status":"pending"})  for key_phrase in key_phrases ]
        # Get the tweets
